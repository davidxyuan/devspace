...
export function registerArtifactTools(server, { config, workspaces, incomingArtifactAdapters = [], }) {
    ...
    registerAppTool(server, "download_artifact", {
        ...
        description: "Stream one MCP-host-provided native file to a requested relative path inside a workspace. Existing destinations, arbitrary URLs, absolute paths, traversal, symlinked parents, source filesystem paths, and malformed file objects are rejected.",
        inputSchema: {
