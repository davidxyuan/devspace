...
function migrateLocalAgentStructuredErrors(sqlite) {
...
function migrateLocalAgentEffortRename(sqlite) {
    const columns = sqlite.prepare("pragma table_info(local_agent_sessions)").all();
